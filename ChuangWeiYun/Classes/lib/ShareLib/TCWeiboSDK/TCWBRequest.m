...
- (void)handleResponseData:(NSData *)data{
    if (delegate != nil && [delegate respondsToSelector:@selector(request:didReceiveRawData:)]){
	...
	if (error) {
        ...
        if (delegate != nil && [delegate respondsToSelector:@selector(request:didFinishLoadingWithResult:)]){
