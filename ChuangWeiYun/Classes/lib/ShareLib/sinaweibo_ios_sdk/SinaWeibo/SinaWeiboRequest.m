...
- (void)handleResponseData:(NSData *)data 
{
    if (self.delegate != nil && [delegate respondsToSelector:@selector(request:didReceiveRawData:)])
    {
	...
	else 
	{
        ...
        {
            if (self.delegate != nil && [delegate respondsToSelector:@selector(request:didFinishLoadingWithResult:)])
            {
...
- (void)connection:(NSURLConnection *)connection didReceiveResponse:(NSURLResponse *)response
{
	...
	if (delegate != nil && [delegate respondsToSelector:@selector(request:didReceiveResponse:)])
    {
