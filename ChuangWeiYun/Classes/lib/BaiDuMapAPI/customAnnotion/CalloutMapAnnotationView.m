...
- (id) initWithAnnotation:(id <BMKAnnotation>)annotation reuseIdentifier:(NSString *)reuseIdentifier {NSLog(@"35");
...
- (void)setAnnotation:(id <BMKAnnotation>)annotation {NSLog(@"45");
...
- (void)setAnnotationBitch:(id <BMKAnnotation>)annotation {NSLog(@"53");
	[super setAnnotation:annotation];
	[self prepareFrameSize];
	[self prepareOffset];
	[self prepareContentFrame];
...
- (void)prepareFrameSize {NSLog(@"53");
...
- (void)prepareContentFrame {NSLog(@"64");
...
- (void)adjustMapRegionIfNeeded {NSLog(@"91");
	//Longitude
...
- (CGFloat)xTransformForScale:(CGFloat)scale {NSLog(@"135");
...
- (CGFloat)yTransformForScale:(CGFloat)scale {NSLog(@"140");
...
- (void)animateInStepTwo {NSLog(@"159");
...
- (void)animateInStepThree {NSLog(@"172");
...
- (void)didMoveToSuperview {NSLog(@"183");
	[self adjustMapRegionIfNeeded];
	[self animateIn];
}

- (void)drawRect:(CGRect)rect {NSLog(@"draw rect");
	CGFloat stroke = 1.0;
	CGFloat radius = 7.0;
...
- (CGFloat)yShadowOffset {NSLog(@"298");
	if (!_yShadowOffset) {
...
- (CGFloat)relativeParentXPosition {NSLog(@"311");
	CGPoint parentOrigin = [self.mapView convertPoint:self.parentAnnotationView.frame.origin 
											 fromView:self.parentAnnotationView.superview];
	return parentOrigin.x + self.offsetFromParent.x;
}

- (UIView *)contentView {NSLog(@"317");
	if (!_contentView) {
