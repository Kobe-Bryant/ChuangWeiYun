...
//  cw
//
//  Created by yunlai on 13-11-19.
//
//

#import "UICutLineView.h"

@implementation UICutLineView
...
-(void)drawRect:(CGRect)rect{
    ...
    CGContextMoveToPoint(context, 0.0, 1.0);  //将路径绘制的起点移动到一个位置，即设置线条的起点
    CGContextAddLineToPoint(context, 320.0,1.0);  //在图形上下文移动你的笔画来指定线条的重点
